...
For this Full-Stack Todo App project, use the following specialized agents for different aspects of development:

### Auth Agent
- Use for implementing user authentication and authorization
- Handles Better Auth integration for signup/signin functionality
- Manages JWT token generation and validation
- Implements secure session management

### Frontend Agent
- Use for developing the Next.js 16+ frontend interface
- Creates responsive UI components using App Router
- Implements client-side routing and user experience features
- Builds the user interface for todo management

### Database Agent
- Use for designing and managing the Neon Serverless PostgreSQL database
- Creates and manages SQLModel schemas
- Handles database migrations and optimization
- Designs efficient data models for the todo application

### Backend Agent
- Use for developing the Python FastAPI RESTful API endpoints
- Implements server-side business logic
- Creates API routes and request/response models
